...
require (
	...
	github.com/tochemey/ego v1.1.6-0.20240320072328-86a893a96c82 // indirect
	github.com/tochemey/ego/v3 v3.1.3 // indirect
	github.com/tochemey/goakt v1.5.0 // indirect
